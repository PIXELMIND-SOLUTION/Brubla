...
//                   <div className="text-xs text-gray-400 line-through">
//                     ${(item.displayActualPrice * item.quantity).toFixed(2)}
//                   </div>
//                 )}
//                 {item.displayActualPrice && (
//                   <div className="text-xs text-green-600">
//                     Save ${((item.displayActualPrice - item.price) * item.quantity).toFixed(2)}
//                   </div>
//                 )}
//               </div>
...
//   // Update quantity
//   const updateQuantity = async (cartItemId, productId, variantId, newQuantity) => {
//     try {
//       const response = await axios.put(`${API_BASE_URL}/users/update-cart/${userId}`, {
//         productId,
//         variantId,
...
//   const removeItem = async (cartItemId, productId, variantId) => {
//     try {
//       const response = await axios.delete(`${API_BASE_URL}/users/remove-from-cart/${userId}`, {
...
//     alert("Item saved for later!");
//     removeItem(cartItemId, null, null);
//   };
...
//         // Clear cart items after 2 seconds
//         setTimeout(() => {
...
//                     onClick={placeOrder}
//                     disabled={loading}
//                     className="w-full py-2.5 sm:py-3 rounded-lg text-white font-semibold flex items-center justify-center gap-2 text-sm sm:text-base transition-all hover:opacity-90 disabled:opacity-50"
//                     style={{ backgroundColor: COFFEE }}
//                   >
//                     {loading ? (
//                       <>
