...
// ─────────────────────────────────────────────────────────────────────────────
// NOTIFICATION BANNER — always black
// ─────────────────────────────────────────────────────────────────────────────
const NOTIFS = [
...
const BrublaWordmark = ({ onClick }) => (
    ...
    >
        <span
            ...
            style={{ fontSize: "22px", color: "#000", lineHeight: 1 }}
        >
            BRUBLA
        </span>
    </button>
    ...
    return (
        <>
            ...
            <header ref={headerRef} className="fixed top-0 left-0 right-0 z-[500] transition-all duration-300">
                ...
                {/* Main header bar — fixed white background */}
                <div
                    ...
                    <div className="hidden lg:grid items-center h-16 px-8" style={{ gridTemplateColumns: "1fr auto 1fr" }}>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                style={{ color: showCollections ? "#000" : textColor }}
