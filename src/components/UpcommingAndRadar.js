...
const HeartIcon   = ({ c = "w-4 h-4", filled = false }) => (
  <Ic className={c} fill={filled ? "currentColor" : "none"}
...
const CountUnit = ({ value, label, accent }) => (
  <div className="flex flex-col items-center">
    <span
      ...
      style={{ fontSize: "clamp(18px,3vw,24px)", color: accent,
...
const UpcomingCard = ({ item, index }) => {
  ...
  return (
    ...
    >
      ...
      {/* Blur glass stripe */}
      <div className="absolute inset-0"
           style={{ background: "linear-gradient(180deg,transparent 50%,rgba(12,12,12,0.45) 100%)",
                    backdropFilter: "blur(0px)" }} />

      {/* Top: label chip */}
      <div className="absolute top-4 left-4 right-4 flex items-center justify-between z-10">
        <span className="text-[9px] font-black tracking-[0.14em] uppercase px-2.5 py-1 rounded-full"
              style={{ background: item.accent, color: "#0C0C0C" }}>
          {item.label}
        </span>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 px-4 pb-4 pt-2">
        ...
        <div className="flex items-center gap-1.5 mb-3 px-3 py-2 rounded-xl"
             style={{ background: "rgba(12,12,12,0.55)", backdropFilter: "blur(10px)",
                      border: `1px solid ${item.accent}25` }}>
          <ClockIcon c="w-3 h-3 flex-shrink-0" style={{ color: item.accent }} />
          <div className="flex items-center gap-1 ml-1">
            <CountUnit value={time.d} label="D" accent={item.accent} />
            <CountSep accent={item.accent} />
            <CountUnit value={time.h} label="H" accent={item.accent} />
            <CountSep accent={item.accent} />
            <CountUnit value={time.m} label="M" accent={item.accent} />
            <CountSep accent={item.accent} />
            <CountUnit value={time.s} label="S" accent={item.accent} />
          </div>
        </div>
        ...
        <button
          ...
          style={{
            ...
            color:      notified ? "#0C0C0C" : "rgba(255,255,255,0.85)",
...
export function UpcomingSection() {
  ...
  return (
    <section className="w-full py-12 md:py-16" style={{ background: "#0C0C0C" }} aria-label="Upcoming Collections">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={headerRef} className="px-4 md:px-6 lg:px-10 xl:px-14 pt-10">
          ...
          >
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.24em] mb-1" style={{ color: "#C9A96E" }}>
                What's Next
              </p>
              <h2 className="font-black leading-none"
                  style={{ fontSize: "clamp(24px,4vw,42px)", color: "#F5F0E8",
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl"
        ...
        <div className="absolute top-3 left-3 z-10 flex items-center gap-1.5">
          <span className="text-[9px] font-black tracking-[0.1em] uppercase px-2 py-0.5 rounded-lg"
                style={{ background: item.accent, color: "#0C0C0C" }}>
            {item.badge}
          </span>
        </div>
        ...
        <div className="absolute top-3 right-3 z-10 flex items-center gap-1 px-2 py-1 rounded-full"
          ...
          <EyeIcon c="w-2.5 h-2.5 text-white/70" />
        ...
        <button
          ...
          className="absolute right-2.5 bottom-14 z-10 flex items-center justify-center rounded-full transition-all duration-300"
          style={{
            width: "30px", height: "30px",
            background: wishlisted ? "#e85d4a" : "rgba(255,255,255,0.88)",
            color: wishlisted ? "#fff" : "#0C0C0C",
            boxShadow: "0 2px 10px rgba(12,12,12,0.2)",
            opacity: hovered ? 1 : 0.75,
            transform: hovered ? "scale(1)" : "scale(0.9)",
          }}
        >
          <HeartIcon c="w-3.5 h-3.5" filled={wishlisted} />
        </button>
      ...
      <div className="mt-3 px-0.5">
        ...
        <h3 className="font-black leading-tight mb-2 line-clamp-2"
            style={{ fontSize: "clamp(12px,2vw,14px)", color: "#0C0C0C",
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            style={{
              ...
              background: "linear-gradient(145deg,#1a1812,#0C0C0C)",
              color: "#C9A96E",
    ...
    <section className="w-full py-12 md:py-16" style={{ background: "#FEFCF8" }} aria-label="Designs on Your Radar">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={headerRef} className="px-4 md:px-6 lg:px-10 xl:px-14">
          ...
          >
            <div>
              ...
              <h2 className="font-black leading-none"
                  style={{ fontSize: "clamp(24px,4vw,42px)", color: "#0C0C0C",
                           fontFamily: "Georgia,'Times New Roman',serif", letterSpacing: "-0.02em" }}>
                Designs on Your Radar
              </h2>
              <p className="text-xs font-medium mt-1.5" style={{ color: "#8A8070" }}>
        ...
        <div className="sm:hidden flex justify-center mt-5 px-4">
          <button
            className="w-full max-w-sm flex items-center justify-center gap-2 py-3.5 rounded-2xl font-black text-sm tracking-wide active:scale-98"
            style={{
              background: "#0C0C0C", color: "#C9A96E",
              border: "1.5px solid rgba(201,169,110,0.2)",
